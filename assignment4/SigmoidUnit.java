 ...
 * 
 * @author search1
 * Sigmoid로 사용되고 있는 weka의 multilayerPerceptron(neural network)를 ReLU, LeakyReLU, softPlus로 변경하면서 테스트
 * 변경 메소드는 outputValue, errorValue
 */
...
/**
	 * 
	 */
	private static final long serialVersionUID = 2806511249311439024L;
...
/**
  ...
  public double outputValue(NeuralNode node) {
    ...
    */  
    ...
    //softPlus 방식. ReLU보다 결과가 좋다
    value = Math.log(1 + Math.exp(value));
