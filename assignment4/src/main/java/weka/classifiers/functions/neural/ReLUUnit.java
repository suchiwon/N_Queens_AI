 ...
 * neuralnode to perform all it's computations (as a ReLU unit).
 *
 * @author search1 (mfw4@cs.waikato.ac.nz)
 * @version $Revision: 8034 $
 */
public class ReLUUnit implements NeuralMethod, RevisionHandler {
