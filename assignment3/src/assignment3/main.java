 ...
 * file: main.java
 * comment: N-queens 문제를 처리하는 방식 중 CSP를 backtracking, forward checking, arc consistance 3가지의 방식을 순서대로 실행하는 메인 코드 부분
...
public class main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//forward checking 알고리즘을 위의 CSP 알고리즘의 실행 방법과 같이 처리
			...
			//arc consistance 알고리즘을 위의 CSP 알고리즘의 실행 밥법과 같이 처리
			startTime = System.currentTimeMillis();
